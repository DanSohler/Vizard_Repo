...
public class HeadBob : MonoBehaviour
{
    ...
    private Vector3 FocusTarget()
    {
        ...
        Vector3 pos = new Vector3(_cameraHolder.forward.x, transform.position.y + _cameraHolder.localPosition.y, _cameraHolder.forward.z);
        pos += _cameraHolder.forward * 13.0f;
        return pos;
    }
